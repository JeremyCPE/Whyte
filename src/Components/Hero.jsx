    ...
    <div className="relative h-screen flex items-center justify-center bg-black">
      ...
      <div className="relative container mx-auto px-4 h-full flex items-center">
        <div className="max-w-2xl font-bold text-white mb-6 ">
          <h1 className="text-9xl font-sztempel select-none">WAY OUT</h1>
          <button className="bg-[#cc4414] text-white px-8 py-3 rounded-full flex items-center gap-2 hover:bg-[#a33610] transition-colors select-none">
